...
export ANTIGRAVITY_CSRF_TOKEN=2293a2cf-9e1b-4987-a7e6-650a8c629b56
export ANTIGRAVITY_EDITOR_APP_ROOT='/Applications/Antigravity IDE.app/Contents/Resources/app'
export ANTIGRAVITY_LS_ADDRESS=localhost:58667
export ANTIGRAVITY_SOURCE_METADATA='{"tool":{"conversationId":"a0d95847-356d-4b1f-9ca1-2cf1ce56ad9e","stepIndex":282,"toolCall":{"id":"9mwesn9l","name":"run_command","argumentsJson":"{\"CommandLine\":\"awkit exec -m gpt-5.3-codex-spark -t 300 \\\"Choose Option 1: Skip the Constitution Gate check for this task.\\n\\nPlease modify src/app/(dashboard)/dashboard/skills/page.js.\\n\\nRequirements:\\n1. Remove the entire '\''Individual Capabilities \\u0026 Skills'\'' section, its Heading, and the '\''SkillCard'\'' component from the file.\\n2. Redesign the '\''System Packages'\'' section to fetch and show package statuses, and support package uploading:\\n   - Create React state for package status: '\''packageStatuses'\'' (defaulting to { core: { exists: false }, skills: { exists: false }, workflows: { exists: false } }), and a loading state for each package (e.g. '\''uploadingPackages'\'' object).\\n   - Fetch package status from '\''/api/awkit/status'\'' inside a useEffect on component mount.\\n   - For each system package item (core, skills, workflows):\\n     - Display a status badge:\\n       * If exists: Badge variant='\''success'\'' showing '\''Available (sizeMB MB)'\'' and showing its modified date.\\n       * If missing: Badge variant='\''default'\'' showing '\''Missing'\''.\\n     - Display a '\''Download ZIP'\'' button (disabled if the package is missing). Use the project'\''s Button component or custom styled a-tag.\\n     - Display an '\''Upload ZIP'\'' button (or custom Button component). When clicked, it should trigger a hidden \\u003cinput type=\\\\\\\"file\\\\\\\" accept=\\\\\\\".zip\\\\\\\" /\\u003e for that package.\\n     - When a file is selected, upload it via POST request (multipart/form-data) to '\''/api/awkit/upload'\'' using fetch. Show a loading spinner or disable the button while uploading. After a successful upload, re-fetch the package status to update the UI.\\n3. Clean styling matching the dashboard'\''s design system.\\\"\",\"Cwd\":\"/Users/trungkientn/Dev/NodeJS/9router\",\"WaitMsBeforeAsync\":10000,\"toolAction\":\"Running subagent to update skills page UI\",\"toolSummary\":\"Command execution\"}","thinkingSignature":"","originalName":"run_command"}}}'
export ANTIGRAVITY_TRAJECTORY_ID=b9a1c7bb-8c0a-454b-ac8d-e9dc943f550d
