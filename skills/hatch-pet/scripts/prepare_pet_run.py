...
DIGITAL_PET_STYLE = (
    "Codex digital pet vector style: clean smooth 2D mascot sprite, compact chibi "
    "proportions, readable whole-body silhouette, crisp dark outline, controlled "
    "anti-aliased edges, simplified shape language, and clear facial expression that "
    "stays legible at 192x208. Use flat-to-soft cel shading with subtle gradients only "
    "inside the character. Avoid painterly rendering, anime key art, 3D render, glossy "
    "app-icon polish, realistic fur or material texture, noisy texture overlays, and "
    "complex tiny accessories that disappear at pet size."
)
...
Use this prompt as an authoritative sprite-production spec. Do not expand it into a polished illustration, painterly character image, anime key art, 3D render, glossy app icon, realistic animal portrait, or marketing artwork.
...
- Keep the rendering clean 2D vector-like: smooth contours, crisp outline, controlled anti-aliased edges, simplified palette, and readable detail at 192x208.
