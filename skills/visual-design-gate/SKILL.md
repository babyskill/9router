...
4. Áp dụng Rà soát Tâm lý học Hành vi (Gestalt, Goal Gradient, Price Anchoring) trong thiết kế bản vẽ theo [behavioral-design](file:///Users/trungkientn/Dev/NodeJS/main-awf/skills/behavioral-design/SKILL.md).
5. Render screenshot của Pencil (sử dụng `get_screenshot` node id của screen).
```
...
## Behavioral UX & Psychological Elements
- [Habit / Hook Loops]: [e.g., Progress tracking for Goal Gradient, custom avatar setup for IKEA effect]
- [Gestalt Principles]: [e.g., Proximity grouping of fields, Figure/Ground focus for overlays]
- [Monetization & Scarcity]: [e.g., Price anchoring tiers, urgency badges/timers]
